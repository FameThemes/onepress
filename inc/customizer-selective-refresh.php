...
function onepress_customizer_partials( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial(
		'onepress_social_footer_title', array(
	...
	$wp_customize->selective_refresh->add_partial(
		'onepress_newsletter_title', array(
