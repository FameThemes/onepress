<?php
/**
 * Section: Team (declarative list, merged in customize-option-definitions.php).
 *
 * @package onepress
 */
...
if ( ! class_exists( 'Onepress_Config', false ) || ! Onepress_Config::is_section_active( 'team' ) ) {
	return array();
}
