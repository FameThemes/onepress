...
class Onepress_Dashboard {
	...
	function sections_settings(){
	    ...
	    echo '<p class="description">'.__( 'Disable the Customizer sections that you do not have or need anymore to load it faster. Your settings still saved.', 'onepress' ).'</p>';
