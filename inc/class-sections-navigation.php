	...
	function add_customize( $wp_customize, $section_id ) {
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				$wp_customize, $this->get_name( '__color' ),
				array(
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				$wp_customize, $this->get_name( '__color2' ),
				array(
		...
		// Color Settings
		$wp_customize->add_setting(
			$this->get_name( '__label_bg' ), array(
		...
		$wp_customize->add_control(
			new OnePress_Alpha_Color_Control(
				$wp_customize, $this->get_name( '__label_bg' ),
				array(
		...
		// Color Settings
		$wp_customize->add_setting(
			$this->get_name( '__label_color' ), array(
				'sanitize_callback' => 'onepress_sanitize_color_alpha',
				'default'           => '',
			)
		);
		$wp_customize->add_control(
			new OnePress_Alpha_Color_Control(
				$wp_customize, $this->get_name( '__label_color' ),
				array(
	...
	function scripts() {
		if ( get_theme_mod( $this->get_name( '__enable' ), false ) ) {
			if ( is_front_page() ) {
				...
				wp_localize_script(
					'jquery.bully', 'Onepress_Bully', array(
