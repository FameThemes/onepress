				...
				<div class="row">
					...
					<div class="col-sm-6 wow slideInUp">
						...
						<div class="address-box">
							...
							<?php
							if ($onepress_contact_phone != '') :
								$phones = explode(',', $onepress_contact_phone);
							...
							?>
									<div class="address-contact">
										...
										<div class="address-content"><?php echo wp_kses_post($phone); ?></div>
									</div>
							<?php }
							endif; ?>
							...
							if ($onepress_contact_email != '') :
								$emails = explode(',', $onepress_contact_email);
							...
							<?php 
							if ($onepress_contact_fax != '') :
								$faxs = explode(',', $onepress_contact_fax);
								foreach ($faxs as $fax) {
									$fax = trim($fax);
									if (!$fax) {
										continue;
							...
							?>
									<div class="address-contact">
										...
										<div class="address-content"><?php echo wp_kses_post($fax); ?></div>
									</div>
							<?php }
							endif; ?>
						</div>
