...
module.exports = ( env, args ) => {
	...
	const entry = {
		...
		[ `admin/builder-customizer${ suffix }` ]:
			'./src/admin/builder-customizer/index.js',
		[ `admin/customizer-liveview${ suffix }` ]:
			'./src/admin/customizer-liveview.js',
		[ `admin/admin${ suffix }` ]: './src/admin/admin.js',
		[ `frontend/lightgallery${ suffix }` ]:
