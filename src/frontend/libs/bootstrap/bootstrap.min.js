						...
						_ = ( function () {
							...
							return (
								...
								( e.prototype._getRootElement = function ( e ) {
									let n = r.getSelectorFromElement( e ),
										i = ! 1;
									return (
										n && ( i = t( n )[ 0 ] ),
										i ||
								...
								( e.prototype._triggerCloseEvent = function (
									e
								) {
						...
						T = ( function () {
							...
							return (
								...
								( h.prototype._slide = function ( e, n ) {
									...
									const d = this._triggerSlideEvent( s, c );
				...
				( function ( t ) {
					const e = 'collapse',
						...
						E = ( function () {
							...
							return (
								...
								( l.prototype.setTransitioning = function (
									t
								) {
								...
								( l.prototype._getDimension = function () {
									const e = t( this._element ).hasClass(
										p.WIDTH
									);
					...
					return (
						t( document ).on(
							...
							function ( e ) {
								e.preventDefault();
								const n = E._getTargetFromElement( this ),
									i = t( n ).data( a ),
						...
						m = ( function () {
							...
							return (
								( e.prototype.toggle = function () {
									...
									const n = e._getParentFromElement( this ),
								...
								( e._clearMenus = function ( n ) {
									if ( ! n || n.which !== f ) {
										...
										for (
											...
											const s = e._getParentFromElement(
													o[ r ]
												),
												a = { relatedTarget: o[ r ] };
											if (
				...
				( function ( t ) {
					...
					return (
						t( window ).on( f.LOAD_DATA_API, function () {
							for (
								let e = t.makeArray( t( g.DATA_SPY ) ),
									n = e.length;
								n--;
						...
						I = ( function () {
							...
							return (
								...
								( h.prototype.hide = function ( e ) {
									...
									t( this.element ).trigger( o ),
										o.isDefaultPrevented() ||
											...
											( this._activeTrigger[ T.CLICK ] =
												! 1 ),
											( this._activeTrigger[ T.FOCUS ] =
												! 1 ),
											( this._activeTrigger[ T.HOVER ] =
												! 1 ),
											r.supportsTransitionEnd() &&
											t( this.tip ).hasClass( m.FADE )
												? ( ( this._isTransitioning =
								...
								( h.prototype.getTitle = function () {
									let t = this.element.getAttribute(
										'data-original-title'
									);
									return (
										t ||
		...
		( function ( r ) {
			const a = 'popover',
				...
				m = ( function ( s ) {
					function u() {
						return (
							n( this, u ), t( this, s.apply( this, arguments ) )
						);
					}
					return (
						e( u, s ),
